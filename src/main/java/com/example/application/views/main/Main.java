...
public class MainView extends AppLayout {
    ...
    private Component createDrawerContent(Tabs menu) {
        ...
        logoLayout.add(new Image("images/logo.png", "My First App logo"));
        logoLayout.add(new H1("My First App"));
    ...
    private Component[] createMenuItems() {
        return new Tab[]{
                createTab("connect to device", DeviceConnectionView.class),
                createTab("attendance", AttendanceView.class),
                createTab("user", UserView.class),
                createTab("time zone", TimeZoneView.class),
                createTab("device info", DeviceView.class),
                createTab("syncronisation", SyncView.class)
